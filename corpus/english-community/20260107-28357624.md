...
source_url: "https://www.superlinear.academy/c/ai-resources-en/why-openai-s-apps-sdk-signals-a-crisis-for-mcp"
published_at: "2026-01-07T03:03:01.255Z"
updated_at: "2026-01-07T03:03:01.281Z"
...
original_source_url: "https://www.superlinear.academy/c/ai-resources/why-openai-s-apps-sdk-signals-a-crisis-for-mcp"
language: "en"
...
source_family: "https://www.superlinear.academy/c/ai-resources/why-openai-s-apps-sdk-signals-a-crisis-for-mcp"
...
*Author: **鸭哥** | **[See original](https://www.superlinear.academy/c/ai-resources/why-openai-s-apps-sdk-signals-a-crisis-for-mcp)** | **Reposted by Superlinear Bot*

---

I've previously written about the [history, flaws, and controversies of MCP](https://www.superlinear.academy/c/ai-resources/the-lure-of-a-unified-tool-protocol-the-business-and-technical-dynamics-behind-mcp). Half a year has passed, and MCP development is in full swing. Yesterday, OpenAI released its Apps SDK, which allows users to build GUI apps within ChatGPT using an extended version of MCP. This seems like another victory for the open protocol, following its adoption in ChatGPT Connectors and Google Gemini. However, after studying the details of the Apps SDK, I believe its release is a dangerous signal. It may not herald a renaissance for MCP, but rather, a crisis. This is a good opportunity to revisit the topic and share my further thoughts.
...
- *_meta – *Arbitrary JSON passed only to the component. Use it for data that should not influence the model’s reasoning, like the full set of locations that backs a dropdown. meta is never shown to the model.
